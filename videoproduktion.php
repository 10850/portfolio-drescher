    ...
    <body class="video-php">
        ...
        <div id="mitgrid-video">
            ...
            <section class="pre-production">
                ...
                <section class="video-storyboard">
                    ...
                    <ul class="liste" id="storyboard-list">
                        ...
                        <li>Fra hvilken vinkel skal man filme? </li>
                        <li>Hvor lange skal indstillingerne være?</li>
                    </ul>
                </section>
            ...
            <section class="scootervideo">
                ...
                <video id="scooteredit" width="1080px" height="1350px" controls loop>
                   <source src="video/ScooterEdit.mp4" type="video/mp4"> 
                </video>

                <blockquote>Løbehjuls video redigeret på Premiere Rush. Musik: Real Thing af Tilden Parc fra Epidemic Hip-Hop.</blockquote>
        ...
        <script>
            function myFunction() {
                ...
                element.classList.toggle("darkmode-video");
            }
        </script>
