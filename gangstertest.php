...
<head>
    ...
    <title>Gangstertest - Læringsportfolio</title>
    ...
    <body class="gangstertest-php">
        ...
        <div id="mitgrid-gangstertest">
            ...
            <section class="gangstertest-sporgsmal">
                ...
                <ol class="liste" id="sporgsmal-list">
                    <li>
            ...
            <section class="gangster-pointsystem">
                ...
                <ul class="liste" id="pointsystem-list">
                    <li>
            ...
            <section class="dokumentation-gangster">
                ...
                <ul class="liste" id="dokumentation-list">
                    <li>
