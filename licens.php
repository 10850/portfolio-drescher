...
<head>
    ...
    <body class="licens-php">
        <header>
            <?php include 'menu.inc' ?>
        </header>
        
        <h1 class="titel">Licensering og ophavsret</h1>
        ...
        <div id="mitgrid-licens">
            ...
            <section id="gdpr">
                ...
                <p class="body-text">
                    GDPR er Databeskyttelsesforordningen/Persondataforordningen. GDPR står for General Data Protection Regulation, som var lavet af EU. Den har siden 2018 gjaldt for alle virksomheder (Rijna, 2020).
                </p>
                <p class="body-text">
            ...
            <section id="immaterielle-rettigheder ">
                ...
                <p class="body-text">
                    Immaterielle rettigheder er en betegnelse og en lov der omhandler beskyttelsen af en intellektuel frembringelse, som er ting som kunst, billeder, musik, videoer, forretningskendetegn osv. (Rijna, 2020). Der mange forskellige love indenfor dette område, der er ophavsretsloven, brugsmodelloven, designloven og varemærkeloven (ibid).
                </p>
                <ul class="liste">
                    <li>
                        Patentloven beskytter opfindelser (ibid).
                    </li>
                    <li>
                        Brugsmodelloven beskytter tekniske produkter (ibid).
                    </li>
                    <li>
                        Varemærkeloven beskytter forretningskendetegn (ibid).
                    </li>
                    <li>
                        Designloven beskytter udseende af et industrielt produkt (ibid).
                    </li>
                    <li>
            ...
            <section id="open-source">
                ...
                <p class="body-text">
                    Open source er ligesom free software, som er et software som er fritilgængeligt for alle og det kan ændres på som man ønsker (Rijna, 2020).
                </p>
                <p class="body-text">
             ...
             <section class="kilder">
                ...
                <ul class="kildeliste">
                    <li>
                        ...
                        Available at: <a href="kommunikation/Licensering/Hvad%20er%20Ophavsret%20og%20Licensering.pdf" target="_blank">Hvad er Ophavsret og Licensering?</a>
