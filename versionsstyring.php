...
<head>
    ...
    <body class="versionsstyring-php">
        <header class="kodning-header">
            <?php include 'menu.inc' ?>
        </header>
            
            <div id="mitgrid-versionsstyring">
                
                <h1 class="titel">Versionsstyring</h1>
                ...
                <section id="hvad-er-version">
                    ...
                    <p class="body-text">
                        Dette gøre det også nemmere at gå tilbage og frem i forskellige versioner. Hvis det nu skulle være der bliver lavede en fejl eller man har en ændring som skal implimenteres i hovedforløbet (ibid).
                    </p>
                    <p class="body-text">
                        I alle typer it-projekter Udvikling af administrative systemer, apps, embeddede systemer, frameworks, libraries og komponenter, websites m.m. (ibid).
                    </p>
                </section>
